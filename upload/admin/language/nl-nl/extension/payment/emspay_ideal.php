 ...
 */
$_['heading_title'] = 'EMS Online: iDEAL';
$_['text_emspay_ideal'] = '<img src="view/image/payment/emspay_ideal.png" alt="EMS Online" title="EMS Online" />';
...
$_['text_settings_saved'] = 'EMS Online: iDEAL Instellingen bijgewerkt!';
$_['text_edit_ems'] = 'Bewerken EMS Online: iDEAL Instellingen';
$_['text_yes'] = 'Ja';
$_['text_no'] = 'Nee';
...
$_['info_plugin_not_configured'] = 'EMS Online: iDEAL plugin is niet ingesteld.';
...
$_['info_help_country_access'] = 'Maak een lijst van de landcodes (in ISO 2-norm), gevolgd door een komma, waarvan u wilt dat AfterPay beschikbaar is voor betaling. Voorbeeld: BE, NL.';